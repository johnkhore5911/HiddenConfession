...
import { idlFactory } from './Confess_backend.did.js';
export { idlFactory } from './Confess_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CONFESS_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Confess_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Confess_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Confess_backend.did.js")._SERVICE>}
 */
export const Confess_backend = createActor(canisterId);
