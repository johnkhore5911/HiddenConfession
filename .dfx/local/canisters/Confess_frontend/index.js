...
import { idlFactory } from './Confess_frontend.did.js';
export { idlFactory } from './Confess_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CONFESS_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Confess_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Confess_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Confess_frontend.did.js")._SERVICE>}
 */
export const Confess_frontend = createActor(canisterId);
